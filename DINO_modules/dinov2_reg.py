...
def vit_base_reg(patch_size=16, num_register_tokens=0, in_chans=3, channel_adaptive=False, **kwargs):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=768,
        depth=12,
...
def vit_large_reg(patch_size=16, num_register_tokens=0, in_chans=3, channel_adaptive=False, **kwargs):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=1024,
        depth=24,
